...
_EN = {
    ...
    "plant_picker":    "Which plant did you mean?",
    ...
    # scheduler
    "daily_all_good":      "✅ All plants are on schedule today — no watering needed!",
    "daily_header":        "💧 *Today's watering:*",
    ...
    "repot_usage":      "Usage: `/repot <plant> [width_cm] [depth_cm] [soil]`\ne.g. `/repot Jasmine 25 20 potting mix`",
    "repot_logged":     "🪴 Repotting logged for *{name}*",
    "potgroup_usage":   "Usage: `/potgroup <name> <plant1>, <plant2>`\nor `/potgroup clear <plant>`",
    "potgroup_set":     "🪴 *{names}* grouped in pot *{group}*",
    "potgroup_cleared": "🪴 *{name}* removed from its pot group",
    "care_usage":       "Usage: `/care <plant name>`\ne.g. `/care Jasmine`",
    "report_usage":     "Usage: `/report <plant name>`\ne.g. `/report Jasmine`",
    "report_pick":      "Which plant's report?",
    "report_analyzing": "🔍 Analyzing *{name}*… this may take a moment.",
    "report_menu":      "📋 *{name} — Report*\nChoose a section:",
    "report_refresh":   "🔄 Refreshing report for *{name}*…",
    "report_no_data":   "No data yet for this section.",
...
_ES = {
    ...
    "plant_picker":    "¿Cuál planta quisiste decir?",
    ...
    "daily_all_good":      "✅ ¡Todas las plantas están al día — no se necesita riego hoy!",
    "daily_header":        "💧 *Riego de hoy:*",
    ...
    "repot_usage":      "Uso: `/repot <planta> [ancho_cm] [prof_cm] [tierra]`\nej. `/repot Jazmín 25 20 tierra universal`",
    "repot_logged":     "🪴 Cambio de maceta registrado para *{name}*",
    "potgroup_usage":   "Uso: `/potgroup <nombre> <planta1>, <planta2>`\no `/potgroup clear <planta>`",
    "potgroup_set":     "🪴 *{names}* agrupadas en maceta *{group}*",
    "potgroup_cleared": "🪴 *{name}* removida de su grupo de maceta",
    "care_usage":       "Uso: `/care <planta>`\nej. `/care Jazmín`",
    "report_usage":     "Uso: `/report <planta>`\nej. `/report Jazmín`",
    "report_pick":      "¿Reporte de qué planta?",
    "report_analyzing": "🔍 Analizando *{name}*… un momento.",
    "report_menu":      "📋 *{name} — Reporte*\nElige una sección:",
    "report_refresh":   "🔄 Actualizando reporte de *{name}*…",
    "report_no_data":   "Sin datos aún para esta sección.",
